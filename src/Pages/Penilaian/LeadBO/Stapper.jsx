const data = [
    {
      no: 1,
      title: "Pegawai menerima masukan secara rutin dari pimpinan mengenai implementasi nilai BerAKHLAK dalam pelaksanaan tugas sehari-hari",
    },
    {
      no: 2,
      title: "Pimpinan memberikan contoh yang baik dalam implementasi nilai-nilai BerAKHLAK",
    },
    {
      no: 3,
      title:
      ...
      <div>
        <div className="mb-10">
          <h1 className="text-4xl text-black font-bold">
           Indikator Leadership Budaya Berorganisasi (LeadBO)
          </h1>
        </div>
