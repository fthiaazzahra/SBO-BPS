          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
            ...
            >
              ...
              <span className="text-sm font-medium">
                Jumbotron component was launched! See whats new
              </span>
              <svg
            ...
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
              INDIKATOR LEADERSHIP BUDAYA ORGANISASI
            </h1>
            <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
            Indikator leadership budaya organisasi adalah alat ukur yang digunakan untuk menilai sejauh mana kepemimpinan dalam suatu organisasi mendukung, membentuk, dan mencerminkan budaya organisasi.
            </p>
