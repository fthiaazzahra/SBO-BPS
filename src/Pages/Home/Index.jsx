      ...
      <div className="w-full pt-[90px]">
        <section className="relative h-screen  bg-[#E9781A] z-0">
          ...
          <div className="relative px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 z-10 flex items-center justify-center  h-screen gap-4">
            <div className="">
              <h1 className="mb-4 text-2xl md:text-3xl font-bold tracking-tight leading-none text-white animate__animated animate__fadeInDown">
                Selamat Datang di Portal
              </h1>
              <div className="my-10">
                <h1 className="mb-4 text-4xl md:text-5xl font-bold tracking-tight leading-none text-white  animate__animated animate__fadeInLeft">
